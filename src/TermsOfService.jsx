  ...
  return (
    <>
        ...
        <CardContent className="space-y-6">
            ...
            <p className="mb-4">
            This is the terms of use agreement (the <strong>"Agreement"</strong>) that governs your use of Flashkit's website,
            apps, and services. If you do not agree with these terms, please stop using Flashkit's website, uninstall our
            apps, and refrain from using our services.
            </p>

            <h2 className="text-2xl font-semibold mt-8 mb-4">General Terms</h2>
            <p className="mb-4">
            Flashkit may change any of the terms and conditions in this Agreement at any time for any reason. A notice of
            material change will be posted on Flashkit's website, and you are responsible for reviewing the changes. If you
            do not agree with them, do not continue to use Flashkit's website, uninstall our apps, and refrain from using
            our services.
            </p>
            <p className="mb-4">
            Flashkit does not provide any guarantee or warranty of the accuracy of any data or AI-generated content. By
            using Flashkit, you are certifying that you are over 16 years of age or have your legal guardian's permission
            if you are between 13 and 16 years old.
            </p>
            <p className="mb-4">
            The services Flashkit provides include AI-powered creation and updating of social media kits. The resulting
            ...
            <p className="mb-4">
            The content created using Flashkit's services is owned by you, the user. However, you grant Flashkit a
            non-exclusive, worldwide, royalty-free license to use, reproduce, and display your content for the purpose of
            providing and improving our services.
            </p>
            <p className="mb-4">
            Sharing content created with Flashkit is allowed, provided you credit Flashkit as the tool used to generate the
            content. The acceptable way to do this is to provide a link back to Flashkit's website and clearly state in text
            that Flashkit was used to create the content. This includes sharing on social media websites, blogs, and in any
            sort of publication.
            </p>
            <p className="mb-4">
            Content shared from Flashkit on video platforms should include a link in the description and a verbal or written
            acknowledgment of Flashkit as the tool used to create the content in the video itself.
            </p>

            <h2 className="text-2xl font-semibold mt-8 mb-4">Usage Restrictions</h2>
            <p className="mb-4">
            Mass copying of data or content from Flashkit's website (including botting, crawling, scraping, etc.) is not
            allowed and may result in you being blocked from Flashkit's website and services. The only way you may gather
            large amounts of data or content is through our designated export functions or by requesting data directly from
            Flashkit (email our staff or submit a support ticket).
            </p>
            <p className="mb-4">
            It is Flashkit's policy to respect the privacy settings of the social media accounts you connect to our service.
            ...
            <p className="mb-4">
            In order to provide our AI-powered services, Flashkit utilizes API services of third parties including but not
            ...
            <p className="mb-4">
            Flashkit uses AI technology to generate and update social media kits. While we strive for high-quality results,
            ...
            <p className="mb-4">
            Flashkit will use best practices and cutting-edge AI technology to create and update social media kits, but
            ...
            <p className="mb-4">
            The Flashkit platform, including its software, algorithms, and user interface, is the intellectual property of
            Flashkit. Users are granted a limited, non-exclusive license to use the platform for its intended purpose. Any
            ...
            <p className="mb-4">
            Flashkit provides its services on an "as is" and "as available" basis. We do not warrant that the service will
            ...
            <p className="mb-4">
            To the fullest extent permitted by applicable law, Flashkit shall not be liable for any indirect, incidental,
